<?php $__env->startSection('title', 'Nuestras Sucursales - La Zarza Contigo'); ?>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden card-hover">
                    ...
                    <div class="gradient-bg px-6 py-4">
                        ...
                        <?php if($sucursal->codigo): ?>
                            <p class="text-pink-200 text-sm mt-1">
                                ...
                                Código: <?php echo e($sucursal->codigo); ?>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <?php if($sucursal->telefono): ?>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <a href="tel:<?php echo e($sucursal->telefono); ?>" class="text-purple-600 hover:text-purple-800 transition-colors">
                                        <?php echo e($sucursal->telefono); ?>
                        ...
                        <div class="pt-4 border-t border-gray-100 flex space-x-2">
                            ...
                            <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e(urlencode($sucursal->direccion)); ?>" 
                               target="_blank" 
                            ...
                            <?php if($sucursal->telefono): ?>
                                <!-- Botón para llamar -->
                                <a href="tel:<?php echo e($sucursal->telefono); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\appwebzarza\resources\views/branches/index.blade.php ENDPATH**/ ?>