...
<div class="max-w-6xl mx-auto space-y-6">
            ...
            <div>
                ...
                <p class="text-gray-500 mt-1">
                    ...
                    <?php if($admin->esAdminSucursal() && $admin->sucursal): ?>
                        Registrando desde: <strong><?php echo e($admin->sucursal->nombre); ?></strong>
                    <?php else: ?>
                        Panel de Superadministrador
                    <?php endif; ?>
                </p>
            </div>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-500 hover:text-gray-700">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        <form method="POST" action="<?php echo e(route('admin.clientes.registrar.store')); ?>" class="space-y-8" id="clientForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="nombres" id="nombres" value="<?php echo e(old('nombres')); ?>" required maxlength="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['nombres'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="apellido_paterno" id="apellido_paterno" value="<?php echo e(old('apellido_paterno')); ?>" required maxlength="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['apellido_paterno'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="apellido_materno" id="apellido_materno" value="<?php echo e(old('apellido_materno')); ?>" required maxlength="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['apellido_materno'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="<?php echo e(old('fecha_nacimiento')); ?>" required
                            max="<?php echo e(date('Y-m-d', strtotime('-18 years'))); ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['fecha_nacimiento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="rfc" id="rfc" value="<?php echo e(old('rfc')); ?>" maxlength="13"
                            pattern="[A-ZÑ&]{3,4}[0-9]{6}[A-Z0-9]{3}" placeholder="XAXX010101000"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent uppercase bg-gray-50 <?php $__errorArgs = ['rfc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel" name="telefono" id="telefono" value="<?php echo e(old('telefono')); ?>" required
                            pattern="\+52[0-9]{10}" placeholder="+525512345678"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['telefono'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required maxlength="150"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="email" name="email_confirmation" id="email_confirmation" value="<?php echo e(old('email_confirmation')); ?>" required maxlength="150"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select name="estado" id="estado" required onchange="cargarMunicipios(this.value)"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['estado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="municipio" id="municipio" required disabled
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['municipio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="codigo_postal_id" id="codigo_postal_id" required disabled onchange="actualizarCamposColonia()"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['codigo_postal_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="colonia" id="colonia" value="<?php echo e(old('colonia')); ?>" readonly required
                    ...
                    <div>
                        ...
                        <input type="text" name="calle" id="calle" value="<?php echo e(old('calle')); ?>" placeholder="Opcional" maxlength="200"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    <div>
                        <label for="numero" class="block text-sm font-medium text-gray-700 mb-1">Número</label>
                        <input type="text" name="numero" id="numero" value="<?php echo e(old('numero')); ?>" placeholder="Opcional" maxlength="20"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="promo_email" value="1" <?php echo e(old('promo_email') ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="promo_whatsapp" value="1" <?php echo e(old('promo_whatsapp') ? 'checked' : ''); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="campana_id" id="campana_id" value="<?php echo e(old('campana_id')); ?>" maxlength="100"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between pt-6 border-t">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-6 py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\appwebzarza\resources\views/admin/clientes/registrar.blade.php ENDPATH**/ ?>