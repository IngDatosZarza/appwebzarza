<?php $__env->startSection('title', 'Inicio - La Zarza Contigo'); ?>
        ...
        <div class="w-full max-w-5xl space-y-6">
            ...
            <div class="text-center">
                ...
                <h1 class="text-4xl sm:text-5xl font-extrabold text-white leading-tight tracking-tight">
                    Hola, <span class="text-pink-300"><?php echo e($userData['nombre'] ?? 'Usuario'); ?></span>
                ...
                <div class="flex items-center justify-between gap-6">
                    <div class="flex items-center gap-5 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-5xl font-extrabold text-white leading-none counter" data-target="<?php echo e($misCupones ?? 0); ?>"><?php echo e($misCupones ?? 0); ?></p>
            ...
            <div class="glass-card rounded-2xl p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="<?php echo e(route('coupons.index')); ?>" class="action-tile group flex flex-col items-center gap-3 py-6 px-4 rounded-xl text-white text-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\appwebzarza\resources\views/dashboard-simple.blade.php ENDPATH**/ ?>