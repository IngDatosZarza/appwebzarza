...
<?php $__env->startSection('title', 'Mi Sucursal - Dashboard'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <h1 class="text-2xl font-bold text-gray-800">
            ...
            Mi Sucursal: <?php echo e($admin->sucursal ? $admin->sucursal->nombre : 'Sin asignar'); ?>

        </h1>
        <p class="text-gray-500 mt-1">Bienvenido, <?php echo e($admin->nombres); ?>. Aquí puedes ver el resumen de tu actividad.</p>
    </div>
        ...
        <div class="bg-white rounded-lg shadow p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($misClientes); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <a href="<?php echo e(route('admin.clientes.registrar')); ?>" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow group">
            <div class="flex items-center">
        ...
        <a href="<?php echo e(route('admin.mi-sucursal.clientes')); ?>" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow group">
            <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <?php if($ultimosClientes->count() > 0): ?>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3 text-sm text-gray-600"><?php echo e($cliente->telefono); ?></td>
        ...
        <div class="p-8 text-center text-gray-500">
            ...
            <a href="<?php echo e(route('admin.clientes.registrar')); ?>" class="text-indigo-600 hover:text-indigo-800 text-sm mt-2 inline-block">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\appwebzarza\resources\views/admin/sucursal/dashboard.blade.php ENDPATH**/ ?>