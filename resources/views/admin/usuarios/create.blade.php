...
@section('title', 'Crear Administrador de Sucursal')
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">
                    ...
                    Nuevo Administrador de Sucursal
                </h1>
                <p class="text-gray-500 mt-1">Registra un nuevo administrador para gestionar una sucursal</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.usuarios.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="telefono" id="telefono" value="{{ old('telefono') }}" required placeholder="+52XXXXXXXXXX"
            ...
            <div class="border-t pt-4">
                <h3 class="text-sm font-semibold text-gray-700 mb-3"><i class="fas fa-lock mr-1"></i> Contraseña</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-1">Contraseña * (mín. 10 caracteres)</label>
